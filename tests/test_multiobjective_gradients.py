...
def test_conflict_projection_uses_high_precision_anchor_norm_squared():
    anchor = (torch.tensor([-39396696.0, 167620144.0], dtype=torch.float32),)
    direct = (torch.tensor([91283728.0, -388332736.0], dtype=torch.float32),)
