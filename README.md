...
- Config digest: `27a3a6f21c54`
- Capacity basis: `349` configured unique geometries (planning input, not a packaged-corpus claim)
- Lattice / latent width: `96^3` / `192`
- Learning rates (diffusion / converter / consistency student): `0.0002` / `0.0002` / `0.0002`
- Scaled channels: `[48, 80, 112]`; coordinate decoder: `512` wide x `4` residual blocks
- Trainable parameters: `7,394,273` (diffusion `4,023,552`, consistency student `1,150,176`, converter `2,220,545`)
- Trainable FP32 weight storage: `28.2 MiB`
- Resident training-model FP32 parameter storage, including teacher and EMA: `58.9 MiB`
- Static FP32 training-memory lower bound with gradients and AdamW states: `143.5 MiB`
