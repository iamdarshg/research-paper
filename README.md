...
- Config digest: `70a608fb2c59`
- Capacity basis: `500` configured unique geometries (planning input, not a packaged-corpus claim)
- Lattice / latent width: `96^3` / `512`
- Learning rates (diffusion / converter / consistency student): `2e-05` / `2e-05` / `2e-05`
- Scaled channels: `[112, 160, 208]`; coordinate decoder: `1536` wide x `5` residual blocks
- Trainable parameters: `47,077,241` (diffusion `17,378,256`, consistency student `5,241,256`, converter `24,457,729`)
- Trainable FP32 weight storage: `179.6 MiB`
- Resident training-model FP32 parameter storage, including teacher and EMA: `312.2 MiB`
- Static FP32 training-memory lower bound with gradients and AdamW states: `850.9 MiB`
