...
- Scaled channels: `[128, 176, 224]`; coordinate decoder: `2048` wide x `5` residual blocks
- Trainable parameters: `70,081,321` (diffusion `20,819,824`, consistency student `6,165,432`, converter `43,096,065`)
- Trainable FP32 weight storage: `267.3 MiB`
- Resident training-model FP32 parameter storage, including teacher and EMA: `426.2 MiB`
- Static FP32 training-memory lower bound with gradients and AdamW states: `1,228.2 MiB`
