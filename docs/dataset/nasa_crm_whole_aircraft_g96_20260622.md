...
- Manifest: `D:\CodeProjects\research-paper\build\nasa_crm_whole_aircraft_g96\manifest.jsonl`
- Provenance ledger: `D:\CodeProjects\research-paper\build\nasa_crm_whole_aircraft_g96\provenance.json`
- Record count: `15`
...
- Full-aircraft STL artifacts were voxelized at `96^3` with `AircraftDesignDataset._voxelize_stl`.
- Local analysis reports used the repo internal `D3Q27` solver for `5` steps with fixed settings.
...
- Representative grid-refinement report: `D:\CodeProjects\research-paper\build\nasa_crm_whole_aircraft_g96\reports\refinement\grid_refinement.json`
