...
\hline
\textbf{Geometry} & \textbf{Reynolds No.} & \textbf{Internal Solver $C_d$} & \textbf{Literature Range (Target)} \\ \hline
Circular Cylinder & 100 & 1.56 & 1.3 -- 1.6 \cite{geier2015cascaded} \\ \hline
Unit Cube & 1000 & 1.04 & 1.0 -- 1.1 \cite{geier2015cascaded} \\ \hline
\end{tabular}
\end{table}
