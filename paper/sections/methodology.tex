...
To improve the physical plausibility of the generated geometries, we integrate the CFD solver directly into the gradient-based optimization loop. This is achieved by differentiating through the LBM solver or by using the solver as a score-guidance function during the reverse diffusion process. This approach provides a first-order approximation of the aerodynamic manifold within the latent space.
