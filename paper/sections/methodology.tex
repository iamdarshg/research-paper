...
The new sequential path is the first implementation of that candidate-scoring loop, but the claim boundary remains narrow until benchmark reports show that it reliably improves generated candidates under the aircraft-validity and solver-score gates. A stronger future version would still need either a validated differentiable surrogate or repeated black-box optimization evidence showing that solver feedback measurably changes generated candidates.
