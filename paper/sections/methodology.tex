...
In a stronger future version of this pipeline, the repository would need either a validated differentiable surrogate or a sequential candidate-scoring loop showing that solver feedback measurably changes generated candidates. For now, the CFD path is an implemented scoring mechanism rather than evidence of CFD-guided gradient training.
