...
| C08 | `paper/sections/methodology.tex` | methods | implied differentiating through CFD solver | current code routes geometries through an aerodynamic score path, separates differentiable optimizer loss from detached diagnostics, and documents public Airshow corpus construction separately from model validation | `docs/dataset/airshow_corpus_addition_report_20260620.md`; `docs/benchmarks/airshow_loss_debug_20260620.md`; differentiable-CFD or surrogate experiment if upgraded | revised |
